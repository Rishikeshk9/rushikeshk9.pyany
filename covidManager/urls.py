...
urlpatterns = [ path('create/', csrf_exempt(views.create), name='create'),
                ...
                path('redzone/', csrf_exempt(views.redzone), name='redzone'),
                path('fetch/', csrf_exempt(views.fetch), name='fetch'),
                path('redzonecount/', csrf_exempt(views.redzonecount), name='redzonecount'),
